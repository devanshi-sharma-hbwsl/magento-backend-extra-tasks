...
return [
    'modules' => [
        ...
        'Training_ConsoleExample' => 0,
        'Training_Contact' => 0,
        'Training_CronExample' => 0,
        'Training_DependencyExample' => 0,
        'Training_Example' => 0,
        'Training_HeadCssJs' => 0,
        'Training_HeaderFooterScripts' => 0,
        'Training_InjectablesAndNonInjectablesExample' => 0,
        'Training_Interfaces' => 0,
        'Training_LayoutExample' => 0,
        'Training_LayoutMoveExample' => 0,
        'Training_LayoutRemoveExample' => 0,
        'Training_ObserverExample' => 0,
        'Training_PluginExample' => 0,
        'Training_PoolPattern' => 0,
        'Training_Preferences' => 0,
        'Training_Proxy' => 0,
